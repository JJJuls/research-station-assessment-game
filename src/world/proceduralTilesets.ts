...
export const STATION_THEMES: Record<StationThemeId, StationTheme> = {
  hub: {
    ...
    seam: rgb(0x353f52),
    glint: rgb(0x5c6b85),
    // World V1 slice: lifted so large hull masses read as roof plates.
    wallTop: rgb(0x2e3a4c),
    wallEdge: rgb(0x4a5a70),
    wallFace: rgb(0x3a475c),
  ...
  dock: {
    ...
    glint: rgb(0x515d72),
    // World V1 slice: lifted so large hull masses read as roof plates.
    wallTop: rgb(0x2a3442),
    wallEdge: rgb(0x46546a),
    wallFace: rgb(0x364354),
