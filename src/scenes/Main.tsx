...
import type { CanonicalEventContext } from '../world';
import { CANONICAL_EVENT_CONTEXT } from '../world';
...
// Phase A extraction: the CanonicalEventContext interface and
// CANONICAL_EVENT_CONTEXT map moved verbatim to
// src/world/CanonicalEventContext.ts (imported above) so new room scenes
// and this prototype scene share one source of truth. No entries changed.
