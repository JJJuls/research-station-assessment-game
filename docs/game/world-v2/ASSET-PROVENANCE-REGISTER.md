...
| `plates/yard-plate.png`            | `e5fa5c46` (west) + `0c92c2d4` (east, style ref = west)                           | Exterior Recovery Yard two-plate strip (1376×384); facing drift banks form the pass. Landed ahead of the yard's rebuild unit            | Pillow stitch at x = 688 only                                                                                                                                    |
