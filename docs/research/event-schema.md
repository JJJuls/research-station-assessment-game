...
| `tutorial_help_shown`        | `dock_control_familiarisation` | rename      |                                                                                          |
| `tutorial_completed`         | `dock_tutorial_completed`      | exact       |                                                                                          |
| `control_error_count`        | —                              | missing     | No control-error tracking exists.                                                        |
| `baseline_idle_seconds`      | —                              | missing     | `DataQualityTracker` tracks focus-loss, not baseline idle specifically.                  |
