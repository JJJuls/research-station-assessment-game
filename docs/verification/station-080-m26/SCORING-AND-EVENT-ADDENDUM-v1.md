...
| `value`                                                                | number, boolean, object, array or `null`; `null` is the only "not observed"; a partial value is exported under `incomplete`                                                                                                           |
...
| `m05_start_latency`               | per occasion: focused s to first work action + status                                                                                                                                                                                                 | ↑ initiation difficulty  | declined ⇒ excluded; cap ⇒ censored        |
| `m06_unique_correct_orders`       | distinct correct orders inside 60 s                                                                                                                                                                                                                   | ↑ useful output          | period not opened / technical              |
...
| `m12_fields_verified`             | judged fields before release / 6                                                                                                                                                                                                                      | ↑ checking               | no product presented                       |
