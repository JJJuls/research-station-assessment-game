...
| `dock_arrival-airlock-door-v1`     | Dock          | 2026-07-11 | **accepted** (note: ~2px amber indicator dot — flagged to reviewer) |
...
| `archive_room-data-panels-v1`      | Archive       | 2026-07-11 | **accepted** (decor; deliberately dim vs interactables)             |
